...
step_cuda_toolkit() {
    ...
    if command -v nvidia-smi &> /dev/null; then
        if ask "Install CUDA toolkit?"; then
            ...
            wget https://developer.download.nvidia.com/compute/cuda/13.2.1/local_installers/cuda-repo-debian12-13-2-local_13.2.1-595.58.03-1_arm64.deb
            sudo dpkg -i cuda-repo-ubuntu2404-13-2-local_13.2.1-595.58.03-1_arm64.deb
